<template>
  <NuxtLink v-if="data" :href="getFullUrl(data.domain)" target="_blank" rel="nofollow noopener noreferrer"
    ...
    class="flex items-center text-gray-500 border rounded-sm px-4 py-6 transition-colors hover:border-gray-400 hover:text-black">
    <div class="w-12 h-12 mr-4 p-2 flex items-center justify-center bg-gray-200 rounded-md relative">
